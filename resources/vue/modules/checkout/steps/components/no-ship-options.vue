...
<template>
  <div class="col-12 col-md-4 col-sm-7 text-center">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 60 500 420">
      ...
      <g id="freepik--Boxes--inject-64">
        ...
        <path
            ...
            :style="`fill: ${store.brandColor}`"
        ></path>
        <path d="M272.87,276.47a2.9,2.9,0,1,0,.21,0" :style="`fill: ${store.brandColor}`"></path>
        <path d="M306,276.47a2.89,2.89,0,1,0,.22,0" :style="`fill: ${store.brandColor}`"></path>
        <path
        ...
        <rect x="263.07" y="335.07" width="18.31" height="26.53" :style="`fill: ${store.brandColor}`"></rect>
        <rect x="263.07" y="432.18" width="18.31" height="26.53" :style="`fill: ${store.brandColor}`"></rect>
        <path
    ...
    <h3 class="text-center">No Shipping Method Available.</h3>
    <p class="text-center text-muted">Please try again with a different shipping address.</p>
  </div>
</template>