<div {!! $htmlAttributes !!}>
    <div class="w-100 py-5 text-center" id="cart-preloader">
        <img src="{{ mix('/img/loading.gif', 'vendor/widget') }}"
             style="width: 50px; height: 50px; object-fit: contain"/>
    </div>
    <template id="cart-single-item-template">
        {!! $itemRow ?? '' !!}
    </template>
    <div class="row justify-content-center" id="cart-skeleton" style="display: none">
        <div class="col-9 col-md-4">
            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                 viewBox="10 110 500 400">
                <defs>
                    <clipPath id="freepik--clip-path--inject-65">
                        <path
                                ...
                                style="fill:{{ $templateBrandColor }}"></path>
                    </clipPath>
                </defs>
                <g id="freepik--Floor--inject-65">
                    <ellipse id="freepik--floor--inject-65" cx="249.81" cy="337.53" rx="238.19" ry="137.52"
                             style="fill:#f5f5f5"></ellipse>
                </g>
                <g id="freepik--Device--inject-65">
                    <g id="freepik--device--inject-65">
                        <g id="freepik--Mobile--inject-65">
                            <path
                        ...
                        <g id="freepik--Window--inject-65">
                            ...
                            <path
                                    ...
                                    style="fill:#455a64"></path>
                            <polygon points="113.2 295.04 112.28 294.51 113.5 293.8 114.42 294.33 113.2 295.04"
                                     style="fill:#455a64"></polygon>
                            <polygon points="115.04 293.98 113.2 292.92 114.42 292.21 116.26 293.27 115.04 293.98"
                                     style="fill:#455a64"></polygon>
                            <polygon points="116.88 292.92 114.12 291.32 115.34 290.62 118.11 292.21 116.88 292.92"
                                     style="fill:#455a64"></polygon>
                            <polygon points="118.72 291.86 115.04 289.73 116.27 289.02 119.94 291.15 118.72 291.86"
                                     style="fill:#455a64"></polygon>
                            <path
                            ...
                            <path
                                    ...
                                    style="fill:#455a64"></path>
                            <polygon points="198.55 242.73 199.41 242.23 201.39 243.37 200.52 243.87 198.55 242.73"
                                     style="fill:#455a64"></polygon>
                            <polygon points="199.75 242.04 200.6 241.54 202.59 242.69 201.73 243.19 199.75 242.04"
                                     style="fill:#455a64"></polygon>
                            <path
                                    d="M201.93,240.93l1.43.83c.26.15.21.37-.15.57l-.29.17-2-1.15.69-.39A.41.41,0,0,1,201.93,240.93Z"
                                    style="fill:#455a64"></path>
                            <path d="M202.89,240.52a1.23,1.23,0,0,1,.85.23l.31.18c.34.2.53.42.4.5l-.21.14-1.58-.91Z"
                                  style="fill:#455a64"></path>
                            <polygon points="190.21 248.1 193.77 245.01 195.65 247.68 193.19 247.01 190.21 248.1"
                                     style="fill:#455a64"></polygon>
                        </g>
                        <g id="freepik--Button--inject-65">
                            <path
                ...
                <g id="freepik--Cart--inject-65">
                    <g id="freepik--cart--inject-65">
                        ...
                        <path
                                ...
                                style="fill:#455a64"></path>
                        <polygon points="227.18 242.12 170.88 274.63 253.16 322.13 309.46 289.62 227.18 242.12"
                                 style="fill:{{ $templateBrandColor }}"></polygon>
                        <polygon points="227.18 242.12 170.88 274.63 253.16 322.13 309.46 289.62 227.18 242.12"
                                 style="opacity:0.5"></polygon>
                        <polygon points="165.29 206.11 221.01 173.56 227.18 242.12 170.88 274.63 165.29 206.11"
                                 style="fill:{{ $templateBrandColor }}"></polygon>
                        <polygon points="165.29 206.11 221.01 173.56 227.18 242.12 170.88 274.63 165.29 206.11"
                        ...
                        <g style="opacity:0.15">
                            <path
                                    d="M165.29,206.11l5.59,68.52,82.28,47.5,13-57.5Zm32.48,67.45a4.73,4.73,0,0,1-5.9-3.06l-13.59-35.29a4.43,4.43,0,1,1,8.21-3.16l13.6,35.28A4.72,4.72,0,0,1,197.77,273.56Zm25.69,12.08a4.71,4.71,0,0,1-5.9-3.05L204,247.3a4.44,4.44,0,1,1,8.22-3.17l13.59,35.29A4.71,4.71,0,0,1,223.46,285.64Zm25.69,12.09a4.7,4.7,0,0,1-5.89-3.05l-13.6-35.29a4.44,4.44,0,1,1,8.22-3.17l13.59,35.29A4.71,4.71,0,0,1,249.15,297.73Z"></path>
                        </g>
                        <polygon points="266.15 264.63 322.45 232.12 309.46 289.63 253.16 322.13 266.15 264.63"
                                 style="fill:{{ $templateBrandColor }}"></polygon>
                        <polygon points="266.15 264.63 322.45 232.12 309.46 289.63 253.16 322.13 266.15 264.63"
                ...
                <g id="freepik--Arrow--inject-65">
                    <g id="freepik--arrow--inject-65">
                        ...
                        <polygon
                                ...
                                style="fill:#455a64"></polygon>
                        <polygon points="258.17 132.63 262.11 134.9 262.08 159.19 258.14 156.92 258.17 132.63"
        ...
        <div class="col-12 text-center">
            ...
            <a class="btn btn-outline-secondary align-items-center"
               href="{{ $backToShoppingUrl() }}">
                <i class="icon-arrow-left"></i>&nbsp;Back to Shopping
            </a>
        </div>
    </div>
    <div id="cart-summary" class="mb-2" style="display: none">
        @if($allowChangeShipTo && !empty($shipToAddress))
            ...
            <div class="card mb-3">
                <div class="card-body p-3">
                    ...
                    @empty($shipToAddress)
                    @else
                        <p class="mb-0"><b>{{ $shipToAddress->ShipToName }}</b><br>
                            {{ $shipToAddress->ShipToAddress1 }}{{ $shipToAddress->ShipToAddress2 }}{{ $shipToAddress->ShipToAddress3 }}
                            , {{ $shipToAddress->ShipToCity }}, {{ $shipToAddress->ShipToState }}</p>
                    @endempty
                </div>
            </div>
        @endif
...
@pushonce('footer-script')
    <script>
        $(document).ready(function () {
            ...
            @if($updateStyle == 'bulk')
            document.querySelector('#update-quantities-btn')
                .addEventListener('click', (event) => Amplify.updateCart(event));
            @endif
        });
    </script>
@endpushonce
