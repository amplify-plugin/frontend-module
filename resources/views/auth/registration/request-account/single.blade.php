<div class="row">
    ...
    <div class="col-md-6">
        ...
        {!! \Form::rText('customer_account_number', 'Customer Code', null, true, ['placeholder' => 'Enter valid customer code...']) !!}
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        {!! \Form::rPassword('contact_password', 'Password', true, [
    ...
    <div class="col-md-6">
        {!! \Form::rPassword('contact_password_confirmation', 'Retype Password', true, [
            'placeholder' => 'Enter Password',
        ]) !!}
    </div>
</div>
    ...
    <div class="col-md-6">
        @if ($acceptTermsConfirmation)
            ...
            {!! \Form::rCheckbox(
                'contact_accept_term',
                '',
                ['yes' => 'I accept the ' . config('app.name') . ' Terms and Conditions.'],
                [],
                true,
            ) !!}
        @endif
