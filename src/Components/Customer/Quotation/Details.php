...
namespace Amplify\Frontend\Components\Customer\Quotation;
...
class Details extends BaseComponent
{
    ...
    public function render(): View|Closure|string
    {
        ...
        $class = match (config('amplify.client_code')) {
            'RHS' => \Amplify\Frontend\Components\Client\Rhsparts\Quotation\Details::class,
            default => \Amplify\Frontend\Components\Client\Demo\Quotation\Details::class,
        };
