...
namespace Amplify\Frontend\Components\Client\CalTool;
...
class Checkout extends BaseComponent
{
    ...
    public function render(): View|Closure|string
    {
        ...
        return view('widget::client.cal-tool.checkout', compact('templateBrandColor', 'steps', 'cart', 'cartItemCount', 'customer', 'addresses', 'countries', 'states', 'shipOptions', 'cenposPaymentUrl', 'clientCode', 'isCreditCardRequired'));
    }
