 ...
 * @class Shipping
 */
class Shipping extends BaseComponent
{
    public function __construct(public bool $isActive = false, public string $id = 'shipping', public ?int $index = null)
    {
        parent::__construct();
    }
    ...
    public function render(): View|Closure|string
    {
        ...
        return view('widget::checkout.shipping', compact('addresses', 'states', 'customer', 'countries', 'shipOptions'));
    }
