...
namespace Amplify\Frontend\Components\Checkout;
...
{
    public function __construct(public bool $isActive = false, public string $id = 'billing', public ?int $index = null)
    {
        parent::__construct();
    }
    ...
    public function render(): View|Closure|string
    {
        ...
        //        $addresses->push($this->loadEmptyBillingLocation());
        ...
        return view('widget::checkout.billing', compact('addresses', 'states', 'customer', 'countries'));
    }

    private function loadEmptyBillingLocation()
    {
