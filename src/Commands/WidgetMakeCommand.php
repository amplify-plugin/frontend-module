...
class WidgetMakeCommand extends Command
{
    ...
    private string $classRootNamespace = 'Amplify\Frontend\Components';
    ...
    public function __construct()
    {
        ...
        $this->classRootDir = base_path('packages/frontend/src/Components');

        $this->bladeRootDir = base_path('packages/frontend/resources/views');
    }
    ...
    {
        $config_path = base_path('packages/frontend/config/widget.php');
