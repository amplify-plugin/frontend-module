...
class ShippingController extends Controller
{
    public function store(Request $request)
    {
        ...
        $rules = [
            ...
            'shipping_name' => 'required|string|max:255|ascii',
            'shipping_address1' => 'required|string|max:255|ascii',
            'shipping_address2' => 'nullable|string|max:255|ascii',
            ...
            'shipping_state' => 'nullable|string|max:255|ascii',
            'shipping_city' => 'required|string|max:255|ascii',
            'shipping_zip' => 'required|string|max:10|ascii',
        ];
